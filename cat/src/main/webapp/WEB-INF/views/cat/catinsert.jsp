	...
	<div>
		<form action="/cat/insert" method="POST" encType="multipart/form-data">
			<table>
				...
				<tr>
					<td>이름</td>
					<td colspan="2"><input type="hidden" name="m_number"
						id="m_number" value="<%=session.getAttribute("m_number")%>"><input
						type="text" id="c_name" name="c_name" required="required"></td>
					<td><input type="file" name="file"></td>
				<tr>
					<td>성별</td>
					<td colspan="2"><input type="radio" name="c_gender" value="남"
				...
				<tr>
					<td>생일</td>
					<td colspan="2">Ex)2018-01-01</td>
					<td><input type="date" id="c_birth" name="c_birth"
						min="1975-12-30" max="2019-1-1"></td>
				</tr>
				<tr>
					<td>식성</td>
					<td></td>
					<td><select id="c_taste" name="c_taste" required="required">
			...
			<div>
				<input type="button" onclick="location.href='/cat/catList'"
					value="돌아가기">
				<button id="catInsertBtn">등록</button>
			</div>
		</form>
	</div>
</body>
