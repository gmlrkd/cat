		...
		$(document)
				.on(
						...
						function() {
							...
							conArea.html("");
							var data = "<textarea name='recontent' id='recontent'>"
									+ conText + "</textarea>";
		...
		<table>
			<tr>
				<td><input type="hidden" id="sessionID"
					...
					&nbsp;${sessionScope.m_id }님</td>
			</tr>
			<tr>
				<td><textarea id="replycontent" rows="4" cols="110"
						placeholder="댓글 내용을 입력하세요."></textarea>
					<button type="button" id="replyInsert">등 록</button></td>
			</tr>
		</table>
		<%
			} else {
