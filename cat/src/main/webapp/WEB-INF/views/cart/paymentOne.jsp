...
<div class="paycontent">
	...
	%>
		<form id="rnpurchase" >
			<input type="hidden" id="p_number" name="p_number" value='<%= session.getAttribute("rnp_pnumber") %>'/>
			<input type="hidden" id="po_amount" name="po_amount" value='<%= session.getAttribute("rnp_pcount") %>'/>
			<input type="hidden" id="po_price" name="po_price" value='<%= session.getAttribute("rnp_pprice") %>'/>
		</form>
		...
		<div class="contents">
			<table>
				...
				<tr>
					...
					<td><input type="text" id="m_milage" name="m_milage" value='<%= session.getAttribute("m_milage") %>' readonly="readonly"></td>
					<td><label>사용할 마일리지</label></td>
					<td><input type="text" id="o_milage" name="o_milage"><input type="button" id="usemilage" value="마일리지사용하기"></td>
				</tr>
				<tr>
