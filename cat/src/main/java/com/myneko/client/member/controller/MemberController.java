...
@SessionAttributes({ "m_id", "m_state", "m_number", "m_name", "m_email", "m_phone", "m_zipcode","m_milage", "m_address" })
	...
	public String loginMember(@RequestParam("id") String id, @RequestParam("pass") String pass, Model model,
		...
		try {
			...
			if (mvo.getM_state().equals("활동")) {
				...
				model.addAttribute("m_name", mvo.getM_name());
				model.addAttribute("m_zipcode", mvo.getM_zipcode());
